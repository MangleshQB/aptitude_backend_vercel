...
from .views import UserMouseTrackingView, UserScreenshotCountView, UserScreenshotView, MissingScreenshotsView, \
    ScreenshotsView, \
    UserMouseTrackingGETView, CreateLog, UserSoftwareUsageView, GetUserSoftwareUsage, GetUserSoftwareUsageReport, \
    getSoftwareDetails, IdleTimeApprovalViewSet, APIErrorLogsViewSet
...
urlpatterns = [
    ...
    path('idle_time_approval_reason_list/', IdleTimeApprovalReasonList.as_view({'get': 'list'}),
         name='idle_time_approval_reason_list'),
]
